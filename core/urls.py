...
urlpatterns = [
    ...
    path("engage/", lists.engage_view, name="engage"),
    path("tasks/<int:pk>/", task_detail.task_detail, name="task_detail"),
    path("projects/", projects.projects_view, name="projects"),
    path("projects/templates/", projects.project_templates, name="project_templates"),
    path("projects/templates/<int:pk>/new/", projects.project_from_template, name="project_from_template"),
    path("projects/templates/<int:pk>/delete/", projects.template_delete, name="template_delete"),
    path("projects/<int:pk>/save-as-template/", projects.template_from_project, name="template_from_project"),
